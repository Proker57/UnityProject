...
namespace NoSuchStudio.Common {
    ...
    public static class UnityObjectLoggerExt {
        ...
        private static void LogStatic<T>(LogType logType, UnityEngine.Object unityObj, string format, params object[] args) {
